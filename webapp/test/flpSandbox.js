					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Non-SAP 시산표 업로드 및 전송",
									"targetURL": "#pgdc0020_1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"pgdc0020_1-display": {
								"semanticObject": "pgdc0020_1",
								"action": "display",
								"description": "Non-SAP 연결 단위 별로 시산표 데이터를 업로드하고, GL 계정코드의 재무제표항목과의 맵핑을 적용하여 저장한 다음, GR 시스템에 전송합니다.",
								"title": "Non-SAP 시산표 업로드 및 전송",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pgdc0020_1",
									"url": sap.ui.require.toUrl("pgdc0020_1")
								}
							}
						}
					}
